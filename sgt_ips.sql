...
-- =====================================================
-- Tabla: historial_mantenimientos (Tabla adicional para futuras mejoras)
-- =====================================================
...
-- Datos de ejemplo para historial de mantenimientos
...
-- Vista: Resumen de equipos por ubicación
...
-- Vista: Resumen de equipos por responsable
...
-- Procedimiento: Obtener siguiente código de ubicación
...
-- Procedimiento: Obtener siguiente código de responsable
...
-- Procedimiento: Generar número de activo
...
-- =====================================================
-- Configuración de permisos (ajustar según necesidad)
-- =====================================================
-- GRANT ALL PRIVILEGES ON sgt_ips.* TO 'usuario_sgt'@'localhost' IDENTIFIED BY 'password_seguro';
-- FLUSH PRIVILEGES;
